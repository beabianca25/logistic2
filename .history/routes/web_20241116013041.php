...
// Admin Login Routes
Route::get('/admin/login', [AuthController::class, 'showAdminLoginForm'])->name('admin.admin-login');
Route::post('/admin/login', [AuthController::class, 'adminLogin']);

// User Login Routes
Route::get('/user/login', [AuthController::class, 'showUserLoginForm'])->name('user.user-login');
