...
Route::resource('booking', VendorBookingController::class);


Route::group(['middleware' => ['auth', 'role_or_permission:vendor|super-admin|admin|view user booking']], function () {
    Route::get('/user/bookings', [VendorBookingController::class, 'userBookings'])->name('user.bookings');
});
...
Route::get('/vendor/booking', [VendorBookingController::class, 'vendorBookings'])->name('vendor.booking');
