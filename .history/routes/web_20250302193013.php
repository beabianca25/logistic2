...
// Routes for Customers (view & place bids)
Route::middleware(['auth', 'role:customer'])->group(function () {
    Route::get('/auction', [AuctionController::class, 'show'])->name('auction.index');
    Route::post('/bid', [BidController::class, 'placeBid'])->name('bid.place');
});
