...
Route::group(['middleware' => ['auth', 'role_or_permission:super-admin|manage permissions|manage roles|manage users']], function () {
...
Route::get('/test-role', function () {
    ...
    return $user->hasRole('super-admin') ? 'User has Super Admin role' : 'User does NOT have Super Admin role';
});
