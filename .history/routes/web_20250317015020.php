...
Route::get('/vehicles/{vehicle}/location-history', [VehicleController::class, 'locationHistory'])->name('vehicles.locationHistory');


Route::post('/vehicle/{id}/location/update', [VehicleController::class, 'updateLocation'])->name('vehicle.updateLocation');
