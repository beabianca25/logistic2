...
// Vehicle Management (Edit, Update, Delete) - Only Super Admins and Admins
Route::group(['middleware' => ['auth', 'role_or_permission:super-admin|admin']], function () {
    ...
    Route::get('/vehicle/{vehicle}', [VehicleController::class, 'show'])->name('vehicle.show'); // Fix: GET, not DELETE
    Route::get('/vehicle/create', [VehicleController::class, 'create'])->name('vehicle.create'); // Show create form
    Route::post('/vehicle', [VehicleController::class, 'store'])->name('vehicle.store'); // Store new vehicle

});

// Vehicle Viewing - Vendors, Admins, Super Admins, OR Users with 'view vehicles' Permission
Route::group(['middleware' => ['auth', 'role_or_permission:vendor|super-admin|admin|view vehicles']], function () {
