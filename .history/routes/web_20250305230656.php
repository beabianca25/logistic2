...
Route::get('/calendar/delete/{id}', [EventController::class, 'deleteEvent'])->name('calendar.delete');
...
Route::view('/calendar/add', 'calendar.add')->name('calendar.add');
Route::post('/calendar/create', [EventController::class, 'create'])->name('calendar.create');

Route::get('/calendar/add', [EventController::class, 'create'])->name('calendar.add');
