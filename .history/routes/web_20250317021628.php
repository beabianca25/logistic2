...
Route::get('/vehicle/{id}/history', [VehicleController::class, 'locationHistory'])->name('vehicle.history');
...
Route::get('/vehicle/{id}/location', [VehicleController::class, 'showLocation'])->name('vehicle.location');
Route::get('/vehicle/{id}/location', [VehicleController::class, 'showLocation'])->name('vehicle.location');
