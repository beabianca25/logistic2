...
Route::group(['middleware' => ['auth', 'role_or_permission:super-admin|admin']], function () {
    ...
    Route::delete('/vehicle/{vehicle}', [VehicleController::class, 'show'])->name('vehicle.show');
});

Route::group(['middleware' => ['auth', 'role_or_permission:vendor|super-admin|admin', 'role_or_permission:view vehicles']], function () {
