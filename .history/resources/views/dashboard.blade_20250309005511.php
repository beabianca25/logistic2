                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    ...
                                    <div class="progress">
                                        <div id="upcoming-progress" class="progress-bar bg-fuchsia" role="progressbar"
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        function updateProgress() {
                                            ...
                                            if (!upcomingCountElement) return;
                                        ...
                                        // Real-time Update: Observe changes in #upcoming-count
                                        let targetNode = document.getElementById('upcoming-count');
                                        if (targetNode) {
                                            let observer = new MutationObserver(updateProgress);
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-6">
                                <div class="description-block border-right">
                                    <span id="revenue-percentage" class="description-percentage text-success">
                                        <i class="fas fa-caret-up"></i> 17%
                                    </span>
                                    <h5 id="total-revenue" class="description-header">₱35,210.43</h5>
                            ...
                            <div class="col-sm-3 col-6">
                                <div class="description-block border-right">
                                    <span id="cost-percentage" class="description-percentage text-warning">
                                        <i class="fas fa-caret-left"></i> 0%
                                    </span>
                                    <h5 id="total-cost" class="description-header">₱10,390.90</h5>
                            ...
                            <div class="col-sm-3 col-6">
                                <div class="description-block border-right">
                                    <span id="profit-percentage" class="description-percentage text-success">
                                        <i class="fas fa-caret-up"></i> 20%
                                    </span>
                                    <h5 id="total-profit" class="description-header">₱24,813.53</h5>
                            ...
                            <div class="col-sm-3 col-6">
                                <div class="description-block">
                                    <span id="goal-percentage" class="description-percentage text-danger">
                                        <i class="fas fa-caret-down"></i> 18%
                                    </span>
                                    <h5 id="goal-completions" class="description-header">1200</h5>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            function fetchUpdatedData() {
                                fetch('/api/dashboard-stats') // Laravel route that returns JSON data
                                    .then(response => response.json())
                                    .then(data => {
                                        // Update Total Revenue
                                        document.getElementById('total-revenue').innerText = `$${data.total_revenue.toLocaleString()}`;
                                        document.getElementById('revenue-percentage').innerHTML = 
                                            `<i class="fas ${data.revenue_change >= 0 ? 'fa-caret-up text-success' : 'fa-caret-down text-danger'}"></i> ${data.revenue_change}%`;
                    
                                        // Update Total Cost
                                        document.getElementById('total-cost').innerText = `$${data.total_cost.toLocaleString()}`;
                                        document.getElementById('cost-percentage').innerHTML = 
                                            `<i class="fas ${data.cost_change === 0 ? 'fa-caret-left text-warning' : (data.cost_change > 0 ? 'fa-caret-up text-success' : 'fa-caret-down text-danger')}"></i> ${data.cost_change}%`;
                    
                                        // Update Total Profit
                                        document.getElementById('total-profit').innerText = `$${data.total_profit.toLocaleString()}`;
                                        document.getElementById('profit-percentage').innerHTML = 
                                            `<i class="fas ${data.profit_change >= 0 ? 'fa-caret-up text-success' : 'fa-caret-down text-danger'}"></i> ${data.profit_change}%`;
                    
                                        // Update Goal Completions
                                        document.getElementById('goal-completions').innerText = data.goal_completions.toLocaleString();
                                        document.getElementById('goal-percentage').innerHTML = 
                                            `<i class="fas ${data.goal_change >= 0 ? 'fa-caret-up text-success' : 'fa-caret-down text-danger'}"></i> ${data.goal_change}%`;
                                    })
