...
@section('content')
                            ...
                            <div class="d-flex">
                                ...
                                <p class="ml-auto d-flex flex-column text-right">
                                    <span class="text-bold text-lg"
                                        id="subcontractor-count">{{ $subcontractorCount }}</span>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            fetch('{{ url('/api/get-applications-count') }}')
                            ...
                            datasets: [
                                {
                                    ...
                                    data: [100, 120, 160, 150, 170, 175, 160], // Replace with real data
                                    fill: true,
                                    tension: 0.4
                                },
                                {
                                    ...
                                    data: [80, 85, 90, 95, 100, 110, 120], // Replace with real data
                                    fill: true,
                                    tension: 0.4
                                }
                            ]
