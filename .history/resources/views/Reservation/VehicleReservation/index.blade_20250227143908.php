        ...
        <tbody>
            ...
            <tr>
                ...
                <div class="d-flex justify-content-around align-items-center">
                    <a href="{{ route('reservation.show', $supply->id) }}" class="btn btn-info btn-sm mx-0">
                        <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('reservation.edit', $supply->id) }}" class="btn btn-warning btn-sm mx-0">
                        <i class="fas fa-edit"></i>
                    </a>

                    <form action="{{ route('reservation.destroy', $supply->id) }}" method="POST" id="deleteForm{{ $supply->id }}" class="mx-0">
                        @csrf
                        @method('DELETE')
