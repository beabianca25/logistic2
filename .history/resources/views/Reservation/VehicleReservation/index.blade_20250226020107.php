    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($reservation->vehicles->isNotEmpty())
                ...
                <td><span class="badge bg-{{ $reservation->status === 'Pending' ? 'warning' : ($reservation->status === 'Approved' ? 'success' : ($reservation->status === 'Cancelled' ? 'danger' : 'secondary')) }}">{{ $reservation->status }}</span></td>
