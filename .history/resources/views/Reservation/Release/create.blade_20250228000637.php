...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('release.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="vehicle_reservation_id" name="vehicle_reservation_id" required>
                                ...
                                @foreach ($reservations as $reservation)
                                    <option value="{{ $reservation->reference_code }}"
                                        ...
                                        {{ $reservation->vehicle->vehicle_type }} ({{ $reservation->vehicle->license_plate }})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="customer_contact" name="customer_contact" readonly required>
                        </div>

                        <div class="mb-3">
                            <label for="reservation_date" class="form-label">Reservation Date</label>
                            <input type="datetime-local" class="form-control" id="reservation_date" name="reservation_date" readonly required>
                        </div>
    ...
    <script>
        document.getElementById("vehicle_reservation_id").addEventListener("change", function () {
            ...
            document.getElementById("reservation_date").value = selectedOption.getAttribute("data-reservation-date") || "";
        });
    </script>
@endsection
