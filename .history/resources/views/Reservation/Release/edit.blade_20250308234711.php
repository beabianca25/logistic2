                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('release.update', $release->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="reservation_date"
                                    name="reservation_date" value="{{ $release->reservation_date }}" required>
                        ...
                        @if ($release->status !== 'Completed')
                            <a href="{{ route('vehicle.release.complete', ['id' => $release->id]) }}"
                                class="btn btn-primary">Complete Release</a>

                            <form action="{{ route('vehicle.release.complete', ['id' => $release->id]) }}" method="POST"
                                class="mt-3">
                                @csrf
                                @method('PATCH')
