        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-transparent d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('vehiclerelease.create') }}" class="btn btn-sm btn-primary">
                        New Release
                    </a>
                </div>
                            ...
                            <tbody>
                                @foreach ($releases as $release)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('vehiclerelease.show', $release->id) }}"
                                                    class="btn btn-info btn-sm mx-1">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('vehiclerelease.edit', $release->id) }}"
                                                    class="btn btn-warning btn-sm mx-1">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <form action="{{ route('vehiclerelease.destroy', $release->id) }}"
