                        ...
                        <form action="{{ route('release.update', $release->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="reservation_id" name="reservation_id"
                                    value="{{ $release->reservation_id }}" readonly>
                            </div>

                            <!-- Add this Hidden Input to Ensure Submission -->
                            <input type="hidden" name="reservation_id" value="{{ $release->reservation_id }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="reservation_date"
                                    ...
                                    value="{{ old('reservation_date', \Carbon\Carbon::parse($release->reservation_date)->format('Y-m-d\TH:i')) }}"
                                    required>
                            </div>
