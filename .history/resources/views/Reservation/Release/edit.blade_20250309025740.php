                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('release.update', $release->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="vehicle_reservation_id" class="form-label">Select Reservation</label>
                                <select class="form-control" id="vehicle_reservation_id" name="vehicle_reservation_id" required>
                                    <option value="">-- Select a Reservation --</option>
                                    @foreach ($reservations as $reservation)
                                        <option value="{{ $reservation->id }}" 
                                            {{ isset($release) && $release->vehicle_reservation_id == $reservation->id ? 'selected' : '' }}>
                                            {{ $reservation->reference_code }} - {{ $reservation->customer_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
