...
@section('content')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="vehicle_reservation_id" name="vehicle_reservation_id" required>
                                ...
                                <option value="{{ $reservation->id }}" 
                                    ...
                                    data-reservation-date="{{ \Carbon\Carbon::parse($reservation->reservation_start_date)->format('Y-m-d') }}">
   ...
   document.getElementById("vehicle_reservation_id").addEventListener("change", function() {
    ...
    var reservationDate = selectedOption.getAttribute("data-reservation-date") || "";

    if (reservationDate) {
        // Ensure the date is formatted as YYYY-MM-DDTHH:MM for datetime-local
        var formattedDate = new Date(reservationDate).toISOString().slice(0, 16);
