...
<div class="container">
        ...
        <tbody>
            @forelse ($reservations as $reservation)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('reservationvehicle.destroy', $reservation->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this reservation?');">
                            @csrf
                            @method('DELETE')
    ...
    <a href="{{ route('reservationvehicle.create') }}" class="btn btn-primary">Assign Vehicle to Reservation</a>
</div>
@endsection
