                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('vehicle_reservation.update', $vehiclereservation) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="availability_date" id="availability_date" class="form-control" value="{{ $vehiclereservation->availability_date ? $vehiclereservation->availability_date->format('Y-m-d\TH:i') : '' }}">
                            </div>
