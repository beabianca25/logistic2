                ...
                <div class="card">
                    ...
                    <div class="card-body" style="font-size: 0.9rem; font-family: sans-serif;">
                        <ul class="list-unstyled">
                            <li><strong>Vehicle:</strong> {{ $reservation->vehicle->vehicle_type }} {{ $reservation->vehicle->license_plate }}</li>
                            <li><strong>Driver:</strong> {{ $reservation->driver->driver_name }}</li>
