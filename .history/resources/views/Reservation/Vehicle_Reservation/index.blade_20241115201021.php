                    ...
                    <div class="col-md-12">
                        <div class="card-header border-transparent">
                            ...
                            <button type="button" class="btn btn-sm btn-primary float-end" data-bs-toggle="modal"
                                data-bs-target="#createReservationModal" style="font-size: 0.9rem; font-family: sans-serif;">
                                ...
                                <table class="table m-0" style="font-size: 0.9rem; font-family: sans-serif;">
                                    ...
                                    <tbody>
                                        @foreach ($reservations as $reservation)
                                            <tr>
                                                <td>{{ str_pad(strtoupper(dechex($reservation->id)), 4, '0', STR_PAD_LEFT) }}</td>
                                                <td>{{ $reservation->vehicle->vehicle_type }} {{ $reservation->vehicle->license_plate }}</td>
                                                <td>{{ $reservation->driver->driver_name }}</td>
                                                <td>{{ $reservation->seats }}</td>
                                                <td>{{ $reservation->status }}</td>
                                                <td>{{ $reservation->location }}</td>
                                                <td>{{ $reservation->availability_date ? \Carbon\Carbon::parse($reservation->availability_date)->format('Y-m-d H:i') : 'N/A' }}
                                                </td>
