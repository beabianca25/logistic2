...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    Upcoming Schedule
                                    <span class="float-right"><b id="upcoming-count" data-count="{{ $upcomingCount ?? 0 }}">{{ $upcomingCount ?? 0 }}</b>
                                        /200</span>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let upcomingCount = parseInt(upcomingCountElement.innerText.trim());
        ...
        if (!progressBar) {
            console.error("Element #upcoming-progress not found.");
            return;
        }
