...
<script>
    function fetchBidRate() {
        $.ajax({
            ...
            method: "GET",
            success: function(response) {
                let bidRate = parseFloat(response.bidRate) || 0;
                bidRate = Math.min(bidRate, 100); // Ensure it does not exceed 100%
                $("#bidRate").html(bidRate + "<sup style='font-size: 20px'>%</sup>");
            },
