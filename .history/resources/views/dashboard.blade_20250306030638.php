        ...
        <div class="row">
            ...
            <script>
                function fetchDocumentCount() {
                    $.ajax({
                        url: "{{ route('document.count') }}", // Define this route in web.php
                        method: "GET",
                        success: function(response) {
                            $("#documentCount").html(response.documentCount);
                        },
                        error: function(error) {
                            console.log("Error fetching document count", error);
                        }
                    });
                }

                // Fetch document count every 5 seconds
                setInterval(fetchDocumentCount, 1000);
                fetchDocumentCount(); // Initial fetch
            </script>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-fuchsia" style="width: 80%"></div>
                                    </div>
                                </div>
