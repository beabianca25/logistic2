    ...
    <div class="card direct-chat direct-chat-primary flex-grow-1">
        ...
        <div class="card-footer">
            ...
            <div id="suggested-questions" class="mt-2">
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('book vehicle')">How to book a Vehicle?</button>
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('register as vendor')">How do I submit application??</button>
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('check vehicle availability')">What are the available vehicles?</button>
            </div>
        </div>
    </div>
</div>
