            ...
            <nav class="main-header navbar navbar-expand navbar-light navbar-light elevation-1">
                            ...
                            fetch('/get-notifications')
                                ...
                                .then(data => {
                                    ...
                                    data.forEach(notif => {
                                        ...
                                        notifItem.href = "/bids/" + notif.data.bid_id; // Redirect to bid page
                                        notifItem.classList.add("dropdown-item");
                                        notifItem.style.cursor = "pointer"; // Make it visually clickable
                ...
                `;
                                        ...
                                        notifItem.addEventListener("click", function(event) {
                                            event
                                        .preventDefault(); // Prevent default behavior to manually handle redirection

                                            markNotificationAsRead(notif.id, notifItem
                                            .href); // Pass URL for redirection
                                        });
                        ...
                        // Function to mark notifications as read and redirect the user
