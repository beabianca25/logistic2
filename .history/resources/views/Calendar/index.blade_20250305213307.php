...
<head>
    ...
    <!-- jQuery (must be loaded before FullCalendar) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

    <!-- FullCalendar JS -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/6.1.8/main.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/6.1.8/locales-all.min.js"></script>
</head>
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let events = @json($events); // Convert Laravel data to JSON
