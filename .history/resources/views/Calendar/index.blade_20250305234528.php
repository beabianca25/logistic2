    ...
    <script type="text/javascript">
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventContent: function(info) {
                ...
                eventElement.innerHTML = '<span style="cursor: pointer; color:red; font-weight:bold;">❌</span> ' + info.event.title;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(error) {
                                Swal.fire("Error!", "Failed to update event duration.", "error");
                            }
                        });
                    } else {
                        info.revert();
