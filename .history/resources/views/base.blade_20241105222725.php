                            ...
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <li class="nav-item menu">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('asset.index') }}" class="nav-link bg-light">
                                                <i class="far fa-circle text-pink"></i>
                                                <p>Auidit Asset</p>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    {{-- <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{ route('car.index') }}" class="nav-link bg-light">
                                                <i class="far fa-circle text-teal"></i>
                                                <p>Vehicle List</p>
                                            </a>
                                        </li>
                                            ...
                                            {{-- <ul class="nav nav-treeview">
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ route('maintenance.index') }}" class="nav-link bg-light">
                                                        <i class="far fa-circle text-purple"></i>
                                                        <p>Maintenance</p>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{{ route('expenses.index') }}" class="nav-link bg-light">
