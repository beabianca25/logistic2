                                    ...
                                    <tbody>
                                        @foreach ($trips as $trip)
                                            <tr>
                                                ...
                                                <td>{{ $trip->expected_arrival_time->format('Y-m-d H:i') }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-around align-items-center">
                                                        ...
                                                        <form action="{{ route('trip.destroy', $trip->id) }}"
                                                            method="POST" id="deleteForm{{ $trip->id }}"
                                                            class="mx-0">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        <div class="form-group">
                            ...
                            <select name="vehicle_id" class="form-control" required>
                                ...
                                @foreach($vehicles as $vehicle)
                                    <option value="{{ $vehicle->id }}">{{ $vehicle->vehicle_name }} - {{ $vehicle->registration_number }}</option>
                                @endforeach
                            </select>
                        </div>
