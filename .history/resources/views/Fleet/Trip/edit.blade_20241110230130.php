                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('trip.update', $trip->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="departure_time" class="form-control" value="{{ \Carbon\Carbon::parse($trip->departure_time)->format('Y-m-d H:i') }}" required>
                            </div>
                    
                            <div class="form-group">
                                <label for="expected_arrival_time">Expected Arrival Time</label>
                                <input type="datetime-local" name="expected_arrival_time" class="form-control" value="{{ \Carbon\Carbon::parse($trip->expected_arrival_time)->format('Y-m-d H:i') }}" required>
                            </div>
