        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="tab-content mt-3" id="vehicleTabContent">
                    ...
                    <div class="tab-pane fade" id="maintenance-records" role="tabpanel"
                        aria-labelledby="maintenance-records-tab">
                    ...
                    <!-- Trip Details Tab -->
                    <div class="tab-pane fade" id="trip-details" role="tabpanel" aria-labelledby="trip-details-tab">
                        <h3>Trip Details</h3>
