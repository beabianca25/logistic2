                    ...
                    <div class="row" style="font-size: 0.9rem; font-family: sans-serif;">
                        <div class="col-md-12">
                            <div class="card-footer text-right"> <h3 class="card-title">Vehicle List</h3>
                                <a href="{{ route('vehicle.location', $vehicle->id) }}" class="btn btn-info">Set Location</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%;">
                                                        <div class="d-flex flex-column align-items-center">
                                                            ...
                                                            <a href="{{ route('vehicle.history', $vehicle->id) }}" class="btn btn-primary btn-sm">Location History</a>
                                                            @can('delete vehicles')
