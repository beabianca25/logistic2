                        ...
                        @foreach ($vehicle->drivers as $driver)
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        @if ($driver->profile_picture)
                                            <img src="{{ asset('storage/' . $driver->profile_picture) }}" width="100px"
                                                alt="Profile Picture">
                                        @else
                                            No image uploaded
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td>{{ $driver->termination_date }}</td>
                                </tr>
                                <tr>
                                    <th>Driving Experience (Years)</th>
                                    <td>{{ $driver->driving_experience_years }}</td>
                                </tr>
                                <tr>
                                    <th>Assigned Routes</th>
                                    <td>{{ $driver->assigned_routes }}</td>
                                </tr>
                                <tr>
                                    <th>Certifications</th>
                                    <td>{{ $driver->certifications }}</td>
                                </tr>
                                <tr>
                                    <th>Background Check Status</th>
                                    <td>{{ $driver->background_check_status ? 'Passed' : 'Not Passed' }}</td>
                                </tr>
                                <tr>
                                    <th>Accident History</th>
                                    <td>{{ $driver->accident_history }}</td>
                                </tr>
                                <tr>
                                    <th>Training Completed</th>
                                    <td>{{ $driver->training_completed }}</td>
                                </tr>
                                <tr>
                                    <th>Violation Records</th>
                                    <td>{{ $driver->violation_records }}</td>
                                </tr>
                                <tr>
                                    <th>Medical Fitness Certificate</th>
                                    <td>
                                        @if ($driver->medical_fitness_certificate)
                                            <a href="{{ asset('storage/' . $driver->medical_fitness_certificate) }}"
                                ...
                                <tr>
                                    ...
                                    <td>{{ $driver->emergency_contact_number }}</td>
                                </tr>
                                <tr>
                                    <th>Status</th>
                                    <td>{{ $driver->status }}</td>
