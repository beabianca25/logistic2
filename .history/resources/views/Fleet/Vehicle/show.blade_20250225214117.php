                                ...
                                @foreach ($vehicle->trips as $trip)
                                    <div class="col-md-6">
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <p><strong>Trip ID:</strong> {{ str_pad(strtoupper(dechex($trip->id)), 4, '0', STR_PAD_LEFT) }}</p>
                                                <p><strong>Vehicle:</strong> {{ optional($trip->vehicle)->license_plate ?? 'N/A' }}</p>
                                                <p><strong>Driver:</strong> {{ optional($trip->driver)->name ?? 'Unassigned' }}</p>
                                                ...
                                                <p><strong>Expected Arrival:</strong> {{ \Carbon\Carbon::parse($trip->expected_arrival_time)->format('Y-m-d H:i') }}</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <p><strong>Route Details:</strong> {{ $trip->route_details ?? 'N/A' }}</p>
                                                <p><strong>Distance (KM):</strong> {{ $trip->distance_km ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <p><strong>Fuel Cost:</strong> ${{ number_format($trip->fuel_cost, 2) ?? '0.00' }}</p>
                                                <p><strong>Trip Expenses:</strong> ${{ number_format($trip->trip_expenses, 2) ?? '0.00' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
