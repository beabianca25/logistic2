                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="me-3">
                                                            ...
                                                            <img src="{{ asset('storage/' . $vehicle->image_path) }}" alt="Vehicle Image" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;">
                                                        @else
                                                            <p>No image available</p> <!-- Add this for debugging -->
                                                            <img src="{{ asset('images/default-image-path.jpg') }}" alt="No Image" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;">
                                                        @endif
                                                        
                                                        </div>
                                                        <div>
                                                            <p><strong>Model:</strong> {{ $vehicle->model }}
                                                                {{ $vehicle->year }}</p>
                                                            <p><strong>Registration Number:</strong>
                                                                {{ $vehicle->registration_number }}</p>
                                                            <p><strong>Status:</strong>
                                                                {{ ucfirst($vehicle->current_status) }}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('vehicle.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="maintenance_schedule"
