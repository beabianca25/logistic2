                        ...
                        <div class="modal-content" style="font-size: 0.9rem; font-family: serif;">
                            ...
                            @endif
                                ...
                                <form action="{{ route('vehicle.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Status</label>
                                        <input type="text" name="current_status" class="form-control" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Insurance</label>
                                        <input type="text" name="insurance_info" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="trip_expected_arrival_time" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="fuel_cost" class="form-control">
                                    </div>
