                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 25%;">
                                                ...
                                                <img src="{{ asset('path/to/vehicle/image.jpg') }}" alt="Vehicle Image" style="width: 100%; max-width: 200px; object-fit: cover;">
                                            </td>
                                            <td>
                    ...
                    <form action="{{ route('vehicle.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="current_status" id="current_status" class="form-control" required>
                                ...
                                <option value="retired" {{ old('current_status') == 'retired' ? 'selected' : '' }}>Retired</option>
                            </select>
                        </div>
                        <div class="form-group">
