                            ...
                            <div class="table-responsive">
                                <table class="table m-0" style="font-size: 0.9rem; font-family: serif;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ str_pad(strtoupper(dechex($maintenance->id)), 4, '0', STR_PAD_LEFT) }}</td>
                                            <td>{{ $maintenance->maintenance_type }}</td>
                                            <td>{{ \Carbon\Carbon::parse($maintenance->maintenance_date)->format('Y-m-d H:i') }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-around align-items-center">
                                                        ...
                                                        <form action="{{ route('maintenance.destroy', $maintenance->id) }}" method="POST"
                                                            id="deleteForm{{ $maintenance->id }}" class="mx-0">
                                                            @csrf
                                                            @method('DELETE')
