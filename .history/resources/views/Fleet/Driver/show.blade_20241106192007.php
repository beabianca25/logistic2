...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
               <h5 class="card-title"> <strong>Driver Name:</strong> {{ $driver->driver_name }}</h5>
               <p><strong>Vehicle Assigned:</strong> 
                @if ($driver->vehicle)
                    {{ $driver->vehicle->vehicle_type }} - {{ $driver->vehicle->license_plate }}
                @else
                    No vehicle assigned
                @endif
            </p>
               <p><strong>Vehicle Assig:</strong> {{ $driver->vehicle_id }}</p>
