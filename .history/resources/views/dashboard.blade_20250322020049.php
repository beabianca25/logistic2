    ...
    fetch('/get-applications-count') // Fetch real data from Laravel backend
        ...
        .then(data => {
            ...
            new Chart(ctx, {
                ...
                data: {
                    labels: data.dates, // Dates from backend
                    datasets: [
                        {
                            label: 'Vendors',
                            borderColor: 'blue',
                            backgroundColor: 'rgba(0, 123, 255, 0.2)',
                            data: data.vendors, // Vendor count per date
                            fill: false,
                            tension: 0.4
                        },
                        {
                            ...
                            data: data.suppliers, // Supplier count per date
                            fill: false,
                            tension: 0.4
                        },
                        {
                            ...
                            data: data.subcontractors, // Subcontractor count per date
                            fill: false,
                            tension: 0.4
                        }
                    ]
