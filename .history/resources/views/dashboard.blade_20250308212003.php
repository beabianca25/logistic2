                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    Upcoming Schedule
                                    <span class="float-right"><b id="upcoming-count">{{ $upcomingCount ?? 0 }}</b>/200</span>
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function () {
                                        let upcomingCount = parseInt(document.getElementById('upcoming-count').innerText);
                                        let maxCount = 200;
                                        let percentage = (upcomingCount / maxCount) * 100;
                                
                                        document.getElementById('upcoming-progress').style.width = percentage + "%";
                                    });
                                </script>
