                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="progress-group">
                                    Upcoming Schedule
                                    <span class="float-right"><b id="upcoming-count"
                                            data-count="{{ $upcomingCount ?? 0 }}">{{ $upcomingCount ?? 0 }}</b>
                                        /200</span>
                                    <div class="progress progress-sm">
                                        <div id="upcoming-progress" class="progress-bar bg-fuchsia" style="width: 0%;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        setTimeout(() => {
                                            ...
                                            let upcomingCount = parseInt(upcomingCountElement.textContent.trim()) || 0;
                                            let maxCount = 200;
