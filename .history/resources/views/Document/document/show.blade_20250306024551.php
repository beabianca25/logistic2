...
@section('content')
<nav aria-label="breadcrumb" style="font-size: 0.8rem; font-family: sans-serif;">
    <ol class="breadcrumb">
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="font-size: 0.7rem; font-family: sans-serif;">
                    <h5>Document Details</h5>
                </div>
                <div class="card-body" style="font-size: 0.8rem; font-family: sans-serif;">
                    <div class="mb-3">
