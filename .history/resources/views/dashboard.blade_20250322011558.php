                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <p class="d-flex flex-column">
                                <span class="text-bold text-lg" id="vendor-count">0</span>
                                <span>Vendors Applied</span>
                            </p>
                            <p class="ml-auto d-flex flex-column text-right">
                                <span class="text-bold text-lg" id="supplier-count">0</span>
                                <span>Suppliers Applied</span>
                            </p>
                            <p class="ml-auto d-flex flex-column text-right">
                                <span class="text-bold text-lg" id="subcontractor-count">0</span>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        fetch('/api/get-applications-count') // Adjust the endpoint as needed
