    ...
    <div class="card direct-chat direct-chat-primary flex-grow-1">
        ...
        <div class="card-footer">
            ...
            <div id="suggested-questions" class="mt-2">
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('What is the vehicle reservation process?')">What is the vehicle reservation process?</button>
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('How do I track my booking?')">How do I track my booking?</button>
                <button class="btn btn-sm btn-outline-secondary" onclick="sendSuggestedMessage('What are the available vehicles?')">What are the available vehicles?</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function sendMessage(message = null) {
        ...
        $('#chatbox').append('<div class="direct-chat-msg right">' +
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#chatbox').append('<div class="direct-chat-msg">' +
                    '<div class="direct-chat-infos clearfix">' +
