                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" data-bs-toggle="dropdown">
                            ...
                            <span id="notifCount" class="badge badge-warning navbar-badge"
                    ...
                    <script>
                        function loadNotifications() {
                            fetch('/get-notifications')
                                ...
                                .then(data => {
                                    let unreadNotifications = data.filter(notif => !notif.read_at); // Only count unread
                                    ...
                                    unreadNotifications.forEach(notif => {
                                        ...
                                        let targetUrl = `/bids/${notif.data.bid_id}#notif-${notif.id}`; // Add fragment

                                        notifItem.href = targetUrl; // Direct link with fragment
                    ...
                    `;
                        ...
                        // Mark notification as read and update UI without refreshing
                        function markNotificationAsRead(notificationId, redirectUrl, notifItem) {
                            fetch(`/mark-notification-as-read/${notificationId}`, {
                                ...
                                notifItem.remove(); // Remove clicked notification from UI
                                let notifBadge = document.getElementById("notifCount");
                                let notifHeaderCount = document.getElementById("notifHeaderCount");

                                // Decrease count after clicking
                                ...
                                window.location.href = redirectUrl; // Redirect with fragment
                            });
                        }
