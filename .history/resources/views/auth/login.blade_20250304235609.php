...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #f0f0f0, #f9f4f4, #ffffff);
            height: 100vh;
            display: flex;
...
<body>
    ...
    <div class="main-container">
        <div class="left-section">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTawJkegFbeVV3UlMveKCht-XZKpSMCp_HKHQ" alt="jvd logo">
        </div>
 ...
 @endif
            <form method="POST" action="/login">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="email" name="email" placeholder="Enter your username" aria-label="Username">
                </div>
                <div class="mb-3">
