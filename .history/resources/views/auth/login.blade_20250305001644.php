...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link">Fleet Management</a></li>
                    <li class="nav-item"><a href="#" class="nav-link">Vendor Portal</a></li>
                    <li class="nav-item"><a href="/apply" class="nav-link">Join Us</a></li>
    ...
    <div class="main-container">
        <div class="left-section">
            <h1 style="color: rgb(255, 255, 255); font-size: 5rem; text-align: center;">
                Let's Book a Trip!
            </h1>
        </div>
