                ...
                <ul class="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown me-3 d-flex align-items-center">
                        <a class="nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                            <i class="far fa-bell" style="font-size: 1.2rem; color: #555;"></i>
                            <span id="notifCount" class="badge badge-warning navbar-badge ms-1"
                    ...
                    <div class="container" style="font-family: sans-serif; font-size: large;">
                        <nav class="mt-1">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('userdashboard') }}" class="nav-link bg-light">
                                        <i class="nav-icon fas fa-tachometer-alt"></i>
                                        <p>Dashboard</p>
                                    </a>
                                </li>
