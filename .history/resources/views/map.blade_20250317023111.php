...
<script>
    ...
    var polylines = {}; // Store polylines for each vehicle
            ...
            .then(data => {
                data.forEach(vehicle => {
                    if (vehicle.locations.length > 0) {
                        ...
                        // If destination exists, draw a polyline
                        if (vehicle.destination_latitude && vehicle.destination_longitude) {
                            ...
                            // Draw a new polyline
                            polylines[vehicle.id] = L.polyline([
                                [latestLocation.latitude, latestLocation.longitude],
                                destination
                            ], { color: 'red', weight: 4, dashArray: '5, 10' }).addTo(map);
                        }
                    }
                });
            });
