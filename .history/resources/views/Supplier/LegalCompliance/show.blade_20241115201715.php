        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 style="font-size: 1rem; font-family: sans-serif;">Vendor Details
                ...
                <div class="card-body" style="font-size: 0.9rem; font-family: sans-serif;">
                    ...
                    <a href="{{ route('vendor.edit', $vendor) }}" class="btn btn-warning" style="font-size: 0.9rem; font-family: sans-serif;">Edit</a>
                    <a href="{{ route('vendor.index') }}" class="btn btn-secondary" style="font-size: 0.9rem; font-family: sans-serif;">Back to List</a>
                </div>
            </div>
        </div>
    </div>
