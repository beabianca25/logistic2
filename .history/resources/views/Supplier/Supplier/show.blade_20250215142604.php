                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            @if ($legalcompliance)
                                ...
                                <p><strong>Tax Identification Number:</strong>
                                    {{ $legalcompliance->tax_identification_number }}</p>
                                <p><strong>Licenses and Certifications:</strong>
                                    {{ $legalcompliance->licenses_certifications }}</p>
                                <p><strong>Years of Operation:</strong> {{ $legalcompliance->years_of_operation }} years
                                </p>
                            @else
