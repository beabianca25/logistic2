            ...
            <div class="mb-4">
                ...
                <table class="table table-bordered small">
                    <tbody>
                        ...
                        @foreach ([
                            'Registration Number' => $compliance->registration_number,
                            'Tax Identification Number' => $compliance->tax_identification_number,
                            'Licenses and Certifications' => $compliance->licenses_certifications,
                            'Years of Operation' => $compliance->years_of_operation.' years'
                        ] as $label => $value)
                        <tr>
                            <th class="fw-bold">{{ $label }}</th>
                            <td>{{ $value }}</td>
