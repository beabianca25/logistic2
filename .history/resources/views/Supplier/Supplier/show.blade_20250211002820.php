                ...
                <div class="tab-content mt-3" id="supplierTabContent">
                    ...
                    <div class="tab-pane fade" id="legal-compliance" role="tabpanel" aria-labelledby="legal-compliance-tab">
                        ...
                        @foreach ($legalcompliance as $compliance)
                            <p><strong>Registration Number:</strong> {{ $compliance->registration_number }}</p>
                            <p><strong>Tax Identification Number:</strong> {{ $compliance->tax_identification_number }}</p>
                            <p><strong>Licenses and Certifications:</strong> {{ $compliance->licenses_certifications }}</p>
                            <p><strong>Years of Operation:</strong> {{ $compliance->years_of_operation }} years</p>
                            <hr>
                        @endforeach
                    </div>
