    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            fetch('/get-applications-count')
                ...
                .then(data => {
                    const dates = [...new Set([...data.vendors.map(e => e.date), ...data.suppliers.map(e => e.date), ...data.subcontractors.map(e => e.date)])].sort();
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            labels: dates,
                            datasets: [
                                { label: 'Vendors', borderColor: '#00FFFF', backgroundColor: 'rgba(0, 255, 255, 0.3)', data: vendorData, fill: false, tension: 0.4, borderWidth: 2, pointRadius: 5 },
                                { label: 'Suppliers', borderColor: '#F5FF00', backgroundColor: 'rgba(245, 255, 0, 0.3)', data: supplierData, fill: false, tension: 0.4, borderWidth: 2, pointRadius: 5 },
                                { label: 'Subcontractors', borderColor: '#FF073A', backgroundColor: 'rgba(255, 7, 58, 0.3)', data: subcontractorData, fill: false, tension: 0.4, borderWidth: 2, pointRadius: 5 }
                            ]
                        },
                        options: {
                            responsive: true,
                            maintainAspectRatio: false,
                            scales: {
                                x: { title: { display: true, text: 'Application Date' } },
