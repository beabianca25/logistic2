   ...
   document.addEventListener("DOMContentLoaded", function () {
    fetch('/get-applications-count') // Fetch real data from Laravel backend
        ...
        .then(data => {
            ...
            new Chart(ctx, {
                type: 'bar', // Change to bar chart for better visualization
                data: {
                    labels: data.categories, // ['Vendors', 'Suppliers', 'Subcontractors']
                    datasets: [{
                        label: 'Total Applications',
                        backgroundColor: ['blue', 'green', 'red'],
                        data: data.counts, // [vendorCount, supplierCount, subcontractorCount]
                    }]
                },
                options: {
                    responsive: true,
