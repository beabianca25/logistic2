        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-gray-primary bg-light elevation-1">
                ...
                <div style="display: flex; justify-content: center; align-items: center;">
                    <a href="#">
                        <img src="{{ asset('https://scontent.fmnl17-2.fna.fbcdn.net/v/t1.15752-9/462567440_1036653514812914_3779464718084729064_n.png?_nc_cat=111&ccb=1-7&_nc_sid=9f807c&_nc_eui2=AeFkL7x4ajYciDN_erhwmDZOG-nxNRiWjLEb6fE1GJaMsQY5u7xNtT_8w2ccburqsjIcEXWqdzfBzeXpaqx2D510&_nc_ohc=6daECpFM9rYQ7kNvgGAl5FD&_nc_zt=23&_nc_ht=scontent.fmnl17-2.fna&oh=03_Q7cD1QEC5uRVmcFi3UZ2RnH4QnOuvaKMjKkAw4a1CLJYmFd8pg&oe=6755C282') }}"
                            alt="JVD Logo" class="brand-image elevation-0"
                            style="opacity: .8; width: 100px; height: 70px;">
                    </a>
                </div>
                

                <div class="sidebar">
                    <div class="container" style="font-family: serif; font-size: large;">
                        <nav class="mt-1">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <li class="nav-item menu">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('record.index') }}" class="nav-link bg-light">
                                                <i class="far fa-circle text-info"></i>
                                                <p>All Records</p>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <!-- Move Vehicle link here, outside the 'Manage Details' section -->
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="nav nav-treeview">
                                                {{-- Other sub-items inside Manage Details can stay here --}}
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ route('maintenance.index') }}" class="nav-link bg-light">
                                                        <i class="far fa-circle text-pink"></i>
                                                        <p>Maintenance</p>
                                                    </a>
                                                </li>
                            ...
                            <li class="nav-item">
                                    <a href="{{ route('event') }}" class="nav-link bg-light">
