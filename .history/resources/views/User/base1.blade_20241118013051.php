...
<body>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <li class="nav-item">
            <a href="{{ route('user.vendor.auction') }}" class="nav-link">
                        ...
                        <nav class="mt-1">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <li class="nav-item menu-open">
                                    <a href="{{ route('user.dashboard') }}" class="nav-link bg-light">
                                ...
                                <li class="nav-item menu">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{ route('user.vendor.auction') }}" class="nav-link bg-light">
