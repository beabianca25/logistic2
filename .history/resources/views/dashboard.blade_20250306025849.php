        ...
        <div class="row">
            ...
            <script>
                function fetchVehicleCount() {
                    $.ajax({
                        url: "{{ route('vehicle.count') }}", // Create this route in web.php
                        method: "GET",
                        success: function(response) {
                            $("#vehicleCount").html(response.vehicleCount);
                        },
                        error: function(error) {
                ...
                // Fetch vehicle count every 5 seconds
                setInterval(fetchVehicleCount, 5000);
                fetchVehicleCount(); // Initial fetch
            </script>
