...
<div class="container">
    ...
    <a href="{{ route('asset-reports.create') }}" class="btn btn-primary mb-3">Add New Report</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{-- View button --}}
                    <a href="{{ route('asset-reports.show', $report->id) }}" class="btn btn-info btn-sm">View</a>

                    {{-- Edit button --}}
                    <a href="{{ route('asset-reports.edit', $report->id) }}" class="btn btn-warning btn-sm">Edit</a>

                    {{-- Delete button with confirmation --}}
                    <form action="{{ route('asset-reports.destroy', $report->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
