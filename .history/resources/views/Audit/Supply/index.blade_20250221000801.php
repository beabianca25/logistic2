...
@section('content')
    ...
    document.querySelectorAll(".update-stock").forEach(button => {
        button.addEventListener("click", function () {
            ...
            let stockOnHand = parseInt(stockInput.value); // Ensure it's an integer
            ...
            .then(data => {
                stockInput.value = data.stock_on_hand; // Update Stock on Hand input
                remainingStockCell.textContent = data.remaining_stock; // Update Remaining Stock
                alert(data.message);
            })
