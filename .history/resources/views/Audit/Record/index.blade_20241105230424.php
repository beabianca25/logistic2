                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-around align-items-center">
                                                            <a href="{{ route('record.show', $record->id) }}" class="btn btn-info btn-sm mx-1">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            
                                                            <a href="{{ route('record.edit', $record->id) }}" class="btn btn-warning btn-sm mx-1">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            
                                                            <form action="{{ route('record.destroy', $record->id) }}" method="POST" id="deleteForm{{ $record->id }}" class="mx-1">
                                                                @csrf
                                                                @method('DELETE')
