...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <a href="{{ route('assets.create') }}" class="btn btn-success mb-3">Add New Asset</a>
        ...
        <table class="table table-bordered">
            <thead class="table-dark">
                <tr>
                    ...
                    <th>Assigned To</th>
                    <th>Usage Status</th>
                    <th>Warranty Status</th>  <!-- ✅ Added this column -->
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($assets as $asset)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('assets.show', $asset->id) }}" class="btn btn-info btn-sm">Show</a>
