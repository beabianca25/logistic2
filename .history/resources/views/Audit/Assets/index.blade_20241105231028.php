                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-around align-items-center">
                                                            <a href="{{ route('assets.show', $assets->id) }}" class="btn btn-info btn-sm mx-0">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            
                                                            <a href="{{ route('assets.edit', $assets->id) }}" class="btn btn-warning btn-sm mx-0">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            
                                                            <form action="{{ route('assets.destroy', $assets->id) }}" method="POST" id="deleteForm{{ $assets->id }}" class="mx-0">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $assets->id }})">
