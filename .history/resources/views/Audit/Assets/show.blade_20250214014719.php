            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <p><strong>Warranty Expiry Date:</strong> {{ $asset->warranty_expiry_date ?? 'Not Available' }}
                            </p>
                            <p><strong>Maintenance Schedule:</strong> {{ $asset->maintenance_schedule ?? 'None' }}</p>
                            <p><strong>Last Maintenance Date:</strong>
                                {{ $asset->last_maintenance_date ?? 'Not Available' }}</p>
                        </div>
                    </div>
                </div>
