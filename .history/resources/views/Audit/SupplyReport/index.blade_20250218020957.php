            ...
            <tbody>
                @foreach ($supplyReports as $report)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('supplyreports.show', $report) }}" class="btn btn-info btn-sm">View</a>
                            <a href="{{ route('supplyreport.edit', $report) }}" class="btn btn-warning btn-sm">Edit</a>

                            <!-- Delete Form -->
                            <form action="{{ route('supplyreport.destroy', $report) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
