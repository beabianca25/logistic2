        ...
        <tbody>
            @foreach ($supplyReports as $report)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('supply_reports.show', $report) }}" class="btn btn-primary">View</a>
                        <a href="{{ route('supply_reports.edit', $report) }}" class="btn btn-warning">Edit</a>
                        <form action="{{ route('supply_reports.destroy', $report) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
