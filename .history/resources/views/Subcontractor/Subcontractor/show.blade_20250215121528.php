                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p><strong>Payment Terms:</strong> <a href='{{asset('storage/' . $attachment->portfolio_samples )}}' target='_blank'>View File</a> </p>
                            <p><strong>Payment Terms:</strong> {{ $attachment->payment_terms }}</p>
                            <p><strong>Payment Terms:</strong> {{ $attachment->payment_terms }}</p>
                            <p><strong>Payment Terms:</strong> {{ $attachment->payment_terms }}</p>
                            <p><strong>Payment Terms:</strong> {{ $attachment->payment_terms }}</p>
                            <p><strong>Payment Terms:</strong> {{ $attachment->payment_terms }}</p>
