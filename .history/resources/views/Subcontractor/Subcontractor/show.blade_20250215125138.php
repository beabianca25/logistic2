                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            @foreach ($subcontractor->requirements as $requirement)
                                ...
                                <p><strong>Preffered Payment:</strong> {{ $requirement->preffered_payment_terms }}</p>
                                ...
                                <p><strong>Certification/License:</strong> {{ $requirement->certifications_or_licenses}}</p>
                            @endforeach
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p><strong>Aggrement knowledge:</strong> {{ $attachment->aggrement_knowledge ? 'Yes' : 'No' }}</p>
                            <p><strong>Signature:</strong> <a href='{{asset('storage/' . $attachment->signature )}}' target='_blank'>View File</a> </p>
