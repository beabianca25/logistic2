...
<div class="container mt-5">
    ...
    <form action="/subcontractor_attachments/store" method="POST" enctype="multipart/form-data">
        <!-- CSRF Token (If using Laravel, ensure the CSRF token is included in the form for protection) -->
