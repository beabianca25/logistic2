        ...
        <div class="row" style="display: flex; align-items: stretch;">
            ...
            <div class="col-md-4 d-flex flex-column">
                <div class="card direct-chat direct-chat-primary flex-grow-1">
                    ...
                    <div class="card-body">
                        <div id="chatbox" class="direct-chat-messages" style="height: 400px; overflow-y: auto;"></div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var barChartData = {
                            ...
                            datasets: [
                                { label: 'Daily Reservations', backgroundColor: 'rgba(75, 192, 192, 0.8)', data: response.reservationCounts },
                                { label: 'Total Vehicle Releases', backgroundColor: 'rgba(255, 99, 132, 0.8)', data: response.releaseCounts }
                            ]
                        };
                        new Chart(ctx, {
                            type: 'bar',
