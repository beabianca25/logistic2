                    ...
                    datasets: [
                        {
                            ...
                            data: [data.vendors, 0, 0] // Only for Vendors
                        },
                        {
                            label: 'Suppliers',
                            ...
                            borderWidth: 1,
                            barThickness: 50, // Increase bar size
                            data: [0, data.suppliers, 0] // Only for Suppliers
                        },
                        {
                            ...
                            borderWidth: 1,
                            barThickness: 50, // Increase bar size
                            data: [0, 0, data.subcontractors] // Only for Subcontractors
                        }
                    ]
                },
                options: {
                    ...
                    scales: {
                        x: {
                            stacked: true, // Keep bars together
