...
<body class="bg-light">
    <div class="container mt-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                @if($vendorConsent)
                    <p><strong>Consent Given:</strong> {{ $vendorConsent->consent_given ? 'Yes' : 'No' }}</p>
                    <p><strong>Date:</strong> {{ $vendorConsent->date_given }}</p>
                @else
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                @foreach($vendorCertifications as $certification)
