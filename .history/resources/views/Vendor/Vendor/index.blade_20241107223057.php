                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content" style="font-family: serif;">
                                    ...
                                    <div class="modal-body" style="font-size: 0.9rem;">
                                        <form action="{{ isset($vendor) ? route('vendor.update', $vendor->id) : route('vendor.store') }}" method="POST">
                                            @csrf
                                            @if(isset($vendor))
                                                @method('PUT')
                                            @endif
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="vendor_name"
                                                       value="{{ old('vendor_name', optional($vendor)->vendor_name) }}" required>
                                                @error('vendor_name')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="contact_email"
                                                       value="{{ old('contact_email', optional($vendor)->contact_email) }}" required>
                                                @error('contact_email')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="contact_phone"
                                                       value="{{ old('contact_phone', optional($vendor)->contact_phone) }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="service_category" id="service_category" class="form-control" required>
                                                    <option value="" disabled {{ empty(optional($vendor)->service_category) ? 'selected' : '' }}>Select a category</option>
                                                    <option value="Airlines" {{ old('service_category', optional($vendor)->service_category) == 'Airlines' ? 'selected' : '' }}>Airlines</option>
                                                    <option value="Rail Companies" {{ old('service_category', optional($vendor)->service_category) == 'Rail Companies' ? 'selected' : '' }}>Rail Companies</option>
                                                    <option value="Bus/Coach Operators" {{ old('service_category', optional($vendor)->service_category) == 'Bus/Coach Operators' ? 'selected' : '' }}>Bus/Coach Operators</option>
                                                    <option value="Car Rental Agencies" {{ old('service_category', optional($vendor)->service_category) == 'Car Rental Agencies' ? 'selected' : '' }}>Car Rental Agencies</option>
                                                    <option value="Cruise Lines" {{ old('service_category', optional($vendor)->service_category) == 'Cruise Lines' ? 'selected' : '' }}>Cruise Lines</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="contract_start_date"
                                                       value="{{ old('contract_start_date', optional($vendor)->contract_start_date) }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="contract_end_date"
                                                       value="{{ old('contract_end_date', optional($vendor)->contract_end_date) }}">
                                            </div>
