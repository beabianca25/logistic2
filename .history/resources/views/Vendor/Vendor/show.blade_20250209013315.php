...
<div class="container">
    ...
    <p><strong>First Name:</strong> {{ $vendorContact->first_name }}</p>
    <p><strong>Last Name:</strong> {{ $vendorContact->last_name }}</p>
    <p><strong>Job Title:</strong> {{ $vendorContact->job_title }}</p>
    <p><strong>Phone:</strong> {{ $vendorContact->phone }}</p>
    <p><strong>Email:</strong> {{ $vendorContact->email }}</p>
    <a href="{{ route('vendorcontact.edit', $vendorContact->id) }}" class="btn btn-primary">Edit</a>
