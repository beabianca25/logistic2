            ...
            <div class="card-body">
                ...
                <div class="tab-content mt-3" id="vendorTabContent">
                    ...
                    <div class="tab-pane fade" id="certification-details" role="tabpanel" aria-labelledby="certification-details-tab">
                        ...
                        <p><strong>Issuing Organization:</strong> {{ $certification->issuing_organization ?? 'N/A' }}</p>
                        <p><strong>Certification Description:</strong> {{ $certification->certification_description ?? 'No description available' }}</p>
