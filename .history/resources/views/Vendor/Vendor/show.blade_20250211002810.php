        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="vendorTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="certification-details-tab" data-bs-toggle="tab"
                            href="#certification-details" role="tab" aria-controls="certification-details"
                ...
                <div class="tab-content mt-3" id="vendorTabContent">
                    ...
                    <!-- Certifications Tab -->
                    <div class="tab-pane fade" id="certification-details" role="tabpanel"
                        aria-labelledby="certification-details-tab">
                        ...
                        @foreach ($vendor->certifications as $certification)
                            ...
                            <p><strong>Valid Until:</strong>
                                {{ $certification->valid_until ? \Carbon\Carbon::parse($certification->valid_until)->format('F d, Y') : 'N/A' }}
                            </p>
                            <p><strong>Certification File:</strong>
                                @if ($certification->file_path)
                                    <a href="{{ asset('storage/' . $certification->file_path) }}" target="_blank">View
                                        Certification</a>
                                @else
                                    No file uploaded
                                @endif
                    ...
                    <!-- Invoicing Tab -->
                    <div class="tab-pane fade" id="invoicing-details" role="tabpanel"
                        aria-labelledby="invoicing-details-tab">
                        <h3>Invoicing</h3>
                        @foreach ($vendor->invoices as $invoice)
                            ...
                            <p><strong>Additional Instructions:</strong> {{ $invoice->additional_instructions ?? 'None' }}
                            </p>
                            <hr>
                        @endforeach
