            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="Admin Review" {{ $vendor->status == 'Admin Review' ? 'selected' : '' }}>Admin Review</option>
                        <option value="Manager Approved" {{ $vendor->status == 'Manager Approved' ? 'selected' : '' }}>Manager Approved</option>
