                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content" style="font-family: serif;">
                        <div class="modal-header">
                            <h4 class="modal-title" id="editVendorModalLabel" style="font-size: 1rem;">Edit Vendor</h4>
                            ...
                            <form action="{{ route('vendor.update', $vendor->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="service_category" id="service_category" class="form-control" required>
                                        <option value="{{ $vendor->service_category }}">{{ $vendor->service_category }}</option>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary" style="font-size: 0.9rem;">Update Vendor</button>
