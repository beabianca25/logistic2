                ...
                <div class="tab-content mt-3" id="vendorTabContent">
                    ...
                    <div class="tab-pane fade" id="certification-details" role="tabpanel" aria-labelledby="certification-details-tab">
                        ...
                        @foreach ($vendor->certifications as $certification)
                            ...
                            <label><strong>Valid Until:</strong></label>
                            <p>{{ $certification->valid_until ? \Carbon\Carbon::parse($certification->valid_until)->format('F d, Y') : 'N/A' }}</p>
                    
                            <label><strong>Issuing Organization:</strong></label>
                            <p>{{ $certification->issuing_organization ?? 'N/A' }}</p>
                    
                            <label><strong>Certification Description:</strong></label>
                            <p>{{ $certification->certification_description ?? 'No description available' }}</p>
                    
                            <label><strong>Certification File:</strong></label>
                            <p>
