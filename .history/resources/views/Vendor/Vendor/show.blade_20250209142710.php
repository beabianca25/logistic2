    ...
    <div class="container">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="tab-content mt-3" id="vendorTabContent">
                    ...
                    <div class="tab-pane fade" id="certification-details" role="tabpanel" aria-labelledby="certification-details-tab">
                        ...
                        @foreach ($vendor->certifications as $certification)
                            ...
                            <p><strong>Valid Until:</strong> {{ \Carbon\Carbon::parse($certification->valid_until)->format('F d, Y') }}</p>
                ...
                <a href="{{ route('vendors.index') }}" class="btn btn-secondary mt-3">Back</a>
            </div>
        </div>
    </div>
@endsection
