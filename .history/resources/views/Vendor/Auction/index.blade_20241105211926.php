                        ...
                        <tr>
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('storage/' . $auction->image_path) }}" alt="Auction Image" class="img-fluid" style="width: 100px; height: auto; border-radius: 8px;">
                                </div>
                            </td>
                            <td class="align-middle">{{ $auction->id }}</td>
                            <td class="align-middle">{{ $auction->category }}</td>
                            <td class="align-middle">{{ $auction->auction_title }}</td>
                            <td class="align-middle">{{ $auction->year }}</td>
                            <td class="align-middle">{{ $auction->company }}</td>
                            <td class="align-middle">{{ $auction->min_estimate_price }}</td>
                            <td class="align-middle">
                                <a href="{{ route('auction.show', $auction) }}" class="btn btn-info btn-sm" style="font-size: 0.8rem; font-family: serif;">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('auction.edit', $auction) }}" class="btn btn-warning btn-sm" style="font-size: 0.8rem; font-family: serif;">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('auction.destroy', $auction->id) }}" method="POST" id="deleteForm{{ $auction->id }}" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
