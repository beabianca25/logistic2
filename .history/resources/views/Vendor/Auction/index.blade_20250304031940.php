                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @forelse ($auctions as $auction)
                                <tr>
                                    <td>{{ str_pad(strtoupper(dechex($auction->id)), 4, '0', STR_PAD_LEFT) }}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                @can('view auction')
                                                    <li><a class="dropdown-item" href="{{ route('auction.show', $auction->id) }}"><i class="fas fa-eye"></i> View</a></li>
                                                @endcan
                                                @can('edit auction')
                                                    <li><a class="dropdown-item" href="{{ route('auction.edit', $auction->id) }}"><i class="fas fa-edit"></i> Edit</a></li>
                                                @endcan
                                                @can('delete auction')
                                                    <li>
