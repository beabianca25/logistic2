                                        ...
                                        @foreach ($auctions as $auction)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('auction.destroy', $auction) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm" style="font-size: 0.8rem; font-family: serif;" onclick="return confirm('Are you sure?')">
