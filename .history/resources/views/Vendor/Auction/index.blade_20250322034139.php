                        ...
                        <tbody>
                            @forelse ($auctions as $auction)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge 
                                            {{ strtolower(trim($auction->status)) === 'active' ? 'bg-success' : 
                                               (strtolower(trim($auction->status)) === 'sold' ? 'bg-danger' : 
                                               (strtolower(trim($auction->status)) === 'expired' ? 'bg-secondary' : 'bg-primary')) }}">
