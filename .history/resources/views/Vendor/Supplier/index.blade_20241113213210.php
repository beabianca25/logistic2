            ...
            <div class="card">
                <div class="row" style="font-size: 0.9rem; font-family: serif;">
                    <div class="col-md-12">
                        ...
                        <!-- Display Success Message for Supplier -->
                        @if (session('success_supplier'))
                            <script>
                                document.addEventListener('DOMContentLoaded', function () {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Success!',
                                        text: '{{ session("success_supplier") }}',
            ...
            <div class="card">
                <div class="row" style="font-size: 0.9rem; font-family: serif;">
                    <div class="col-md-12">
                        ...
                        <!-- Display Success Message for Subcontractor -->
                        @if (session('success_subcontractor'))
                            <script>
                                document.addEventListener('DOMContentLoaded', function () {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Success!',
                                        text: '{{ session("success_subcontractor") }}',
                                        showConfirmButton: true,
                                    });
                                });
                            </script>
