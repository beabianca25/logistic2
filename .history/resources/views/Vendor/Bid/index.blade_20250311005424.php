                                ...
                                <table class="table m-0" style="font-size: 0.9rem; font-family: sans-serif;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge
                                                    @if($bid->status == 'pending') btn btn-warning 
                                                    @elseif($bid->status == 'active') bg-primary 
                                                    @elseif($bid->status == 'outbid') bg-danger 
                                                    @elseif($bid->status == 'winning') bg-success 
                                                    @elseif($bid->status == 'reserve not met') bg-secondary 
                                                    @elseif($bid->status == 'cancelled') bg-dark 
                                                    @elseif($bid->status == 'closed') bg-info 
                                                    @elseif($bid->status == 'winning bid') bg-success 
                                                    @elseif($bid->status == 'losing bid') bg-danger 
                                                    @elseif($bid->status == 'awarded') bg-success 
