                                ...
                                <table class="table m-0" style="font-size: 0.9rem; font-family: sans-serif;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($bid->status == 'pending') #ffc107
                                            @elseif($bid->status == 'active') #007bff
                                            @elseif($bid->status == 'outbid') #dc3545
                                            @elseif($bid->status == 'winning') #28a745
                                            @elseif($bid->status == 'reserve not met') #6c757d
                                            @elseif($bid->status == 'cancelled') #343a40
                                            @elseif($bid->status == 'closed') #17a2b8
                                            @elseif($bid->status == 'winning bid') #28a745
                                            @elseif($bid->status == 'losing bid') #dc3545
                                            @elseif($bid->status == 'awarded') #28a745
                                            @elseif($bid->status == 'completed') #28a745
                                            @else #f8f9fa @endif;
                                            color: white;">
                                            <span class="badge 
                                            @if($bid->status == 'pending') bg-warning text-dark
                                            @elseif($bid->status == 'active') bg-primary text-white
                                            @elseif($bid->status == 'outbid') bg-danger text-white
                                            @elseif($bid->status == 'winning') bg-success text-white
                                            @elseif($bid->status == 'reserve not met') bg-secondary text-white
                                            @elseif($bid->status == 'cancelled') bg-dark text-white
                                            @elseif($bid->status == 'closed') bg-info text-white
                                            @elseif($bid->status == 'winning bid') bg-success text-white
                                            @elseif($bid->status == 'losing bid') bg-danger text-white
                                            @elseif($bid->status == 'awarded') bg-success text-white
                                            @elseif($bid->status == 'completed') bg-success text-white
