                                    ...
                                    <tbody>
                                        @foreach ($bids as $bid)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge 
                                                    @if ($bid->status == 'pending') badge bg-warning
                                                    @elseif ($bid->status == 'active') badge bg-primary
                                                    @elseif ($bid->status == 'outbid') badge bg-secondary
                                                    @elseif ($bid->status == 'winning') badge bg-danger
                                                    @elseif ($bid->status == 'reserve not met') badge bg-dark
                                                    @elseif ($bid->status == 'cancelled') badge bg-danger
                                                    @elseif ($bid->status == 'closed') badge bg-secondary
                                                    @elseif ($bid->status == 'winning bid') badge bg-success
                                                    @elseif ($bid->status == 'losing bid') badge bg-danger
                                                    @elseif ($bid->status == 'awarded') badge bg-info
                                                    @elseif ($bid->status == 'completed') badge bg-success
