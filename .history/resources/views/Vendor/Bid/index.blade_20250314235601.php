                                        ...
                                        @foreach ($bids as $bid)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($bid->status == 'pending') bg-yellow-500
                                                    @elseif ($bid->status == 'active') bg-blue-500
                                                    @elseif ($bid->status == 'outbid') bg-gray-500
                                                    @elseif ($bid->status == 'winning') bg-red-500
                                                    @elseif ($bid->status == 'reserve not met') bg-gray-700
                                                    @elseif ($bid->status == 'cancelled') bg-red-700
                                                    @elseif ($bid->status == 'closed') bg-gray-500
                                                    @elseif ($bid->status == 'winning bid') bg-green-500
                                                    @elseif ($bid->status == 'losing bid') bg-red-500
                                                    @elseif ($bid->status == 'awarded') bg-blue-400
                                                    @elseif ($bid->status == 'completed') bg-green-500
