                                ...
                                <table class="table m-0" style="font-size: 0.9rem; font-family: sans-serif;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge 
                                                    @if($bid->status == 'pending') badge-warning 
                                                    @elseif($bid->status == 'active') badge-primary 
                                                    @elseif($bid->status == 'outbid') badge-danger 
                                                    @elseif($bid->status == 'winning') badge-success 
                                                    @elseif($bid->status == 'reserve not met') badge-secondary 
                                                    @elseif($bid->status == 'cancelled') badge-dark 
                                                    @elseif($bid->status == 'closed') badge-info 
                                                    @elseif($bid->status == 'winning bid') badge-success 
                                                    @elseif($bid->status == 'losing bid') badge-danger 
                                                    @elseif($bid->status == 'awarded') badge-success 
                                                    @elseif($bid->status == 'completed') badge-success 
