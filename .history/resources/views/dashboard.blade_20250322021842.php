...
document.addEventListener("DOMContentLoaded", function () {
    fetch('/get-applications-count') // Fetch total counts from backend
        ...
        .then(data => {
            ...
            new Chart(ctx, {
                type: 'bar', // Bar chart
                data: {
                    labels: ['Vendors', 'Suppliers', 'Subcontractors'], // X-axis labels
                    datasets: [
                        {
                            label: ['Vendors', 'Suppliers', 'Subcontractors'],,
                            backgroundColor: ['blue', 'green', 'red'], // Different colors for each bar
                            borderColor: ['blue', 'green', 'red'],
                            borderWidth: 1,
                            barThickness: 50, // Increase bar size
                            data: [data.vendors, data.suppliers, data.subcontractors] // Grouped data
                        }
                    ]
                },
                options: {
                    ...
                    scales: {
                        x: {
                            ...
                            barPercentage: 0.9 // Make bars closer
                        },
                        y: {
                            beginAtZero: true
                        }
