...
class VehicleReleaseController extends Controller
{
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        // Save data to history before deleting
    ...
    public function complete($id)
    {
        ...
        // Save completed release to history
        VehicleReleaseHistory::create([
            'vehicle_reservation_id' => $release->vehicle_reservation_id,
            'customer_name' => $release->customer_name,
            'customer_contact' => $release->customer_contact,
        ...
        return redirect()->route('release.index')->with('success', 'Vehicle release marked as completed.');
    }
