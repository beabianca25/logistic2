    ...
    public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'driver_name' => 'required|string|max:255', // Ensure this key matches
        'license_number' => 'required|string|max:255',
        'driver_contact_number' => 'required|string|max:255', // Ensure this key matches
    ...
    Vehicle::create([
        ...
        'driver_name' => $request->driver_name, // Ensure this key matches
        'license_number' => $request->license_number,
        'driver_contact_number' => $request->driver_contact_number, // Ensure this key matches
        'email' => $request->email,
