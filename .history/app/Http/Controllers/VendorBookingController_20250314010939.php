...
class VendorBookingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $vendorBooking->update([
            ...
            'notes' => $request->notes,
            'booking_date' => $request->booking_date,
            'status' => $request->status, // <-- This is important!
        ]);
    ...
    public function vendorBookings()
    {
        ...
        $booking = VendorBooking::where('vendor_id', $vendorId)->with('user')->latest()->get();

        return view('vendor.booking.vendor_index', compact('booking'));
    }
