...
class SupplierProductsServicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        SupplierProductServices::create($validated);
     ...
     */
    public function show(SupplierProductServices $productsservices)
    {
     ...
     */
    public function edit(SupplierProductServices $productsservices)
    {
        return view('Supplier.ProductService.edit', compact('productsservice'));
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(Request $request, SupplierProductServices $productsservices)
    {
        $validated = $request->validate([
            'supplier_id' => 'required|exists:suppliers,id',
            'category' => 'required|string',
        ...
        $productsservices->update($validated);
     ...
     */
    public function destroy(SupplierProductServices $productsservices)
    {
        $productsservices->delete();
