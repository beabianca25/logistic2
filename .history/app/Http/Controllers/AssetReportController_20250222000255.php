...
class AssetReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Asset.AssetReport.index', compact('assetReports'));
    }
    ...
    {
        $assets = Asset::all();
        return view('Asset.AssetReport.create', compact('assets'));
    }
    ...
    public function show($id)
    {
        ...
        return view('Asset.AssetReport.show', compact('assetReport'));
    }
    ...
    public function edit($id)
    {
        $assetReport = AssetReport::findOrFail($id);
        $assets = Asset::all();
        return view('Asset.AssetReport.edit', compact('assetReport', 'assets'));
    }
