...
class SubcontractorRequirementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Create a new subcontractor requirement entry
        SubcontractorRequirement::create([
            'subcontractor_id' => $request->subcontractor_id,
            'estimated_cost' => $request->estimated_cost,
            'preferred_payment_terms' => $request->preferred_payment_terms,
            'start_date_availability' => $request->start_date_availability,
            ...
            'certifications_or_licenses' => $request->certifications_or_licenses,
        ]);
