...
class SupplierReferenceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('Supplier.SupplierReference.create', compact('suppliers'));
    }
    ...
    {
        // Validate the form data, ensuring the supplier ID exists
        $request->validate([
            'supplier_id' => 'required|exists:suppliers,id', // Ensure supplier ID exists
            'client_name' => 'required|string|max:255',
            'client_contact' => 'required|string|max:255',
            'project_description' => 'required|string',
        ]);
    
        // Create the new supplier reference
