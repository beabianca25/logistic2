...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $vendor = Vendor::create($validated);
         ...
         // Count how many vendors are still pending
    $pendingVendorCount = Vendor::where('status', 'Pending')->count();

    // Broadcast event with both the count and notification message
    broadcast(new VendorApplicationSubmitted($pendingVendorCount, $vendor->business_name))->toOthers();
