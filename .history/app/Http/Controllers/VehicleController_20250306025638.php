...
class VehicleController extends Controller
{
    ...
    {
        $vehiclesCount = Vehicle::count(); // Count all vehicles
        $activeVehiclesCount = Vehicle::where('status', 'Active')->count(); // Count only active vehicles
    
        return view('dashboard', compact('vehiclesCount', 'activeVehiclesCount'));
    }
