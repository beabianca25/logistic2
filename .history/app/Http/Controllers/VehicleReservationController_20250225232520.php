...
class VehicleReservationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        VehicleReservation::create($request->all()); // Changed to VehicleReservation

        return redirect()->route('reservation.index')->with('success', 'Reservation created successfully!');
    }

    public function show(VehicleReservation $reservation) // Changed to VehicleReservation
    {
        return view('Reservation.Vehicle_Reservation.show', compact('reservation'));
    }

    public function edit(VehicleReservation $reservation) // Changed to VehicleReservation
    {
        $vehicles = Vehicle::all();
        $drivers = Driver::all();
    ...
    public function update(Request $request, VehicleReservation $reservation) // Changed to VehicleReservation
    {
        $request->validate([
            'vehicle_id' => 'required|exists:vehicles,id',
            'seats' => 'required|integer',
    ...
    public function destroy(VehicleReservation $reservation) // Changed to VehicleReservation
    {
        $reservation->delete();
