...
class VendorContactController extends Controller
{
    ...
    public function store(Request $request, $vendorId)
    {
        ...
        // Redirect to the vendor certification page after storing the contact
        return redirect()->route('vendor.vendorcertification.create', $vendor->id)
                         ->with('success', 'Contact added successfully. Proceed to certification.');
    }
