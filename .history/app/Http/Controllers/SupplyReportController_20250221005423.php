...
class SupplyReportController extends Controller
{
    ...
    {
        // Eager load the 'supply' relationship to optimize queries
    ...
    public function create()
    {
        ...
        return view('Audit.SupplyReport.create', compact('supplies', 'documents'));
    }
    ...
    public function show(AuditReport $auditReport)
    {
        ...
        $auditReport->load('supply'); 
        return view('Audit.SupplyReport.show', compact('auditReport'));
    }
    ...
    public function edit(AuditReport $auditReport)
    {
        ...
        return view('Audit.SupplyReport.edit', compact('auditReport', 'supplies', 'documents'));
    }
    ...
    public function update(Request $request, AuditReport $auditReport)
    {
        ...
        return redirect()->route('audit.index')->with('success', 'Audit report updated successfully.');
    }
