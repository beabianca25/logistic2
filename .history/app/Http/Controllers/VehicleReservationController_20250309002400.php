...
class VehicleReservationController extends Controller
{
    public function index()
    {
        ...
        $upcomingCount = VehicleReservation::where('status', 'Pending')->count();
        return view('Reservation.VehicleReservation.index', compact('reservations', 'reservationCount', 'upcomingCount'));
    }
