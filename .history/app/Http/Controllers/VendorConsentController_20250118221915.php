...
class VendorConsentController extends Controller
{
    ...
    public function store(Request $request, $vendorId)
    {
        ...
        try {
            ...
            // Redirect to the vendor certification page with a success message
            return redirect()->route('vendorconsent.index')->with('success', 'Vendor consent record created successfully.');
        } catch (\Exception $e) {
