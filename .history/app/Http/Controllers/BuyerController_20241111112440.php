...
class BuyerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.buyer.login')->with('success', 'Registration successful! Please log in.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.buyer.show', $buyer->id)->with('success', 'Profile updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('vendor.buyer.index')->with('success', 'Buyer deleted successfully.');
    }
}
