...
class VehicleReservationController extends Controller
{
    public function index()
    {
        ...
        $reservations = VehicleReservation::with(['driver', 'vehicles'])->get();
    ...
    {
        \Log::info('Incoming Reservation Request:', $request->all()); // Debugging line
        ...
        \Log::info('Validation Passed'); // Debugging line
        ...
        // Attach vehicles to the reservation (pivot table)
        $reservation->vehicles()->attach($request->vehicle_ids);

        \Log::info('Reservation Created:', $reservation->toArray()); // Debugging line
    ...
    public function update(Request $request, VehicleReservation $reservation)
    {
        ...
        // Sync vehicles (update pivot table)
