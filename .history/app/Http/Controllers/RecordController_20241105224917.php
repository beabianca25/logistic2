...
use App\Models\Audit_Record; // Use correct model name
...
class RecordController extends Controller
{
    ...
    {
        $auditrecords = Record::all(); // Fetch all audit records
    ...
    public function edit(Audit_Record $auditrecord) // Update parameter type
    {
