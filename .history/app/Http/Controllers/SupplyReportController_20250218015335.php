...
class SupplyReportController extends Controller
{
    ...
    {
        return view('supply_reports.show', compact('supplyReport'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('supply_reports.edit', compact('supplyReport', 'supplies'));
    }
    ...
    public function update(Request $request, SupplyReport $supplyReport)
    {
        ...
        return redirect()->route('supply_reports.index')->with('success', 'Supply Report updated successfully!');
    }
    ...
    public function destroy(SupplyReport $supplyReport)
    {
        ...
        // Redirect to the supply reports index with success message
        return redirect()->route('supply_reports.index')->with('success', 'Supply Report deleted successfully!');
    }
