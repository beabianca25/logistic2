...
class SupplierController extends Controller
{
    ...
    {
        $supplier = Supplier::findOrFail($id);  // Ensures we get a single record
        $legalcompliance = $supplier->legalcompliance; 
        $productservices = $supplier->productservices;
        $financialhealth = $supplier->financialhealth;
        $supplierreferences = SupplierReference::where('supplier_id', $id)->get();
    
        return view('Supplier.Supplier.show', compact(
            'supplier', 'legalcompliance', 'productservices', 'financialhealth', 'supplierreferences'
        ));
    }
