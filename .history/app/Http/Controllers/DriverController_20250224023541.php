...
class DriverController extends Controller
{
    ...
    {
        \Log::info('Request Data:', $request->all()); // Log received request
        ...
        if ($request->hasFile('profile_picture')) {
            ...
            $validatedData['profile_picture'] = $request->file('profile_picture')->store('driver_images', 'public');
        }
        ...
        if ($request->hasFile('medical_fitness_certificate')) {
            ...
            $validatedData['medical_fitness_certificate'] = $request->file('medical_fitness_certificate')->store('medical_certificates', 'public');
        }
    
        // **Force update only present values (avoid overwriting with NULL)**
        $driver->fill($validatedData)->save();
    
        \Log::info('Driver updated successfully:', $driver->toArray());
