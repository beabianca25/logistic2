...
class VehicleController extends Controller
{
  ...
  public function storeLocation(Request $request, $id) {
        ...
        return redirect()->route('vehicle.show', $id)->with('success', 'Location updated successfully.');
    }
...
public function locationHistory($id) {
    ...
    return view('vehicle.history', compact('vehicle'));
}
...
public function showLocation($id)
{
    ...
    return view('Fleet.Vehicle.set-location', compact('vehicle'));
}
