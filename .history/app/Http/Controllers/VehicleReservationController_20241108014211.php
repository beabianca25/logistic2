...
class VehicleReservationController extends Controller
{
    ...
    public function show(Vehicle_Reservation $vehicle_reservation)
    {
        return view('reservation.vehicle_reservation.show', compact('vehicleReservation'));
    }

    public function edit(Vehicle_Reservation $vehicle_reservation)
    {
        $vehicles = Vehicle::all();
        $drivers = Driver::all();
    ...
    public function update(Request $request, Vehicle_Reservation $vehicle_reservation)
    {
        $request->validate([
            'vehicle_id' => 'required|exists:vehicles,id',
            'seats' => 'required|integer',
        ...
        $vehicle_reservation->update($request->all());

        return redirect()->route('vehicle_reservation.index')->with('success', 'Reservation updated successfully!');
    }

    public function destroy(Vehicle_Reservation $vehicle_reservation)
    {
