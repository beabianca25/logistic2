...
class VendorBookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor_bookings.index', compact('bookings'));
    }
    ...
    {
        return view('vendor_bookings.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor_bookings.index')->with('success', 'Vendor booking created successfully.');
    }
    ...
    {
        return view('vendor_bookings.show', compact('vendorBooking'));
    }
    ...
    {
        return view('vendor_bookings.edit', compact('vendorBooking'));
    }
    ...
    public function update(Request $request, VendorBooking $vendorBooking)
    {
        ...
        return redirect()->route('vendor_bookings.index')->with('success', 'Vendor booking updated successfully.');
    }
    ...
    public function destroy(VendorBooking $vendorBooking)
    {
        ...
        return redirect()->route('vendor_bookings.index')->with('success', 'Vendor booking deleted successfully.');
    }
}
