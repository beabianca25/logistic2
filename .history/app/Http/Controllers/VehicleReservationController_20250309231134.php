...
public function getDailyData()
{
    ...
    for ($date = $startDate; $date->lte($endDate); $date->addDay()) {
        ...
        $dates[] = $formattedDate;
        $reservationCounts[] = VehicleReservation::whereDate('created_at', $formattedDate)->count();
        $releaseCounts[] = VehicleReservation::whereDate('released_at', $formattedDate)->count();
    }
