...
class SupplierLegalComplianceController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Fetch legal compliance records
        $legalcompliances = SupplierLegalCompliance::where('supplier_id', $id)->get();
    
        return view('Supplier.Supplier.show', compact('supplier', 'legalcompliances'));
    }
