...
class SupplierProductsServicesController extends Controller
{
     ...
     */
    public function show(SupplierProductServices $productsservice)
    {
     ...
     */
    public function edit(SupplierProductServices $productsservice)
    {
     ...
     */
    public function update(Request $request, SupplierProductServices $productsservice)
    {
        $validated = $request->validate([
            'supplier_id' => 'required|exists:suppliers,id',
            'category' => 'required|string',
     ...
     */
    public function destroy(SupplierProductServices $productsservice)
    {
