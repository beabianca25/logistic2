...
class SupplyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Assuming you're also working with an asset, you'll want to pass that to the event
        $asset = Asset::find($request->input('asset_id')); // Adjust if the asset is related to the supply
