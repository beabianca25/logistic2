...
class ReservationVehicleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('reservation_vehicle.index', compact('reservations'));
    }
    ...
    public function create()
    {
        ...
        return view('reservation_vehicle.create', compact('vehicles', 'reservations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('reservation_vehicle.index')->with('success', 'Vehicle assigned to reservation successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('reservation_vehicle.index')->with('success', 'Vehicle removed from reservation.');
    }
}
