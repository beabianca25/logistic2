...
class VehicleReleaseController extends Controller
{
    ...
    $vehicles = Vehicle::all();
        // Ensure the dates are Carbon instances
        $release->release_date = Carbon::parse($release->release_date);
        $release->drop_off_date = $release->drop_off_date ? Carbon::parse($release->drop_off_date) : null;
    
        return view('Reservation.Release.edit', compact('release', 'reservations', 'vehicles'));
    }
