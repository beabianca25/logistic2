...
class SupplierProductsServicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Redirect back to the supplier's product/service page with a success message
        return redirect()->route('FinancialHealth.create')->with('success', 'Product/Service created successfully.');
    }
