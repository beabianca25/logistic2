...
class VehicleReservationController extends Controller
{
    ...
    public function update(Request $request, VehicleReservation $reservation)
    {
        ...
        if (!$updated) {
            ...
            dd('Update success!', $reservation->fresh()); // Show the updated values
        }
        ...
        if ($reservation->wasChanged('status')) {
            dd('Status updated!', $reservation->status);
        } else {
            dd('Status NOT updated', $reservation->status);
        }
        
        
        // Sync vehicles in pivot table
