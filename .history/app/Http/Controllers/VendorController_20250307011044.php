...
class VendorController extends Controller
{
    ...
    public function myapplication()
    {
        ...
        $applications = $vendor->applications; // Get vendor applications
        $vendors = [$vendor]; // Create an array with the vendor data
    
        return view('Vendor.Vendor.myapp', compact('applications', 'vendors'));
    }
