                        ...
                        <div class="card-header border-transparent">
                            ...
                            <div class="container">
                                ...
                                <button type="button" data-bs-toggle="modal" data-bs-target="#createRecordModal"
                                    class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i>
                                    Add New Record
                                </button>
                            </div>
                                    ...
                                    <table class="table m-0 small-font">
                                        ...
                                        <tbody>
                                            @foreach ($records as $record)
                                                <tr>
                                                    <td>{{ str_pad(strtoupper(dechex($record->id)), 4, '0', STR_PAD_LEFT) }}</td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-around align-items-center">
                                                            <a href="{{ route('record.show', $record->id) }}" class="btn btn-info btn-sm mx-0">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            
                                                            <a href="{{ route('record.edit', $record->id) }}" class="btn btn-warning btn-sm mx-0">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            
                                                            <form action="{{ route('record.destroy', $record->id) }}" method="POST" id="deleteForm{{ $record->id }}" class="mx-0">
                                                                @csrf
                                                                @method('DELETE')
