...
<div class="container mt-4">
    <div class="card shadow-lg p-4">
        ...
        <form action="{{ route('booking.store') }}" method="POST" id="bookingForm">
            ...
            <div class="mb-3">
                <label for="service_type" class="form-label fw-bold">Select Service Type:</label>
            ...
            <div id="num_people_field" class="mb-3 hidden">
                <label for="number_of_people" class="form-label fw-bold">Number of People:</label>
                <input type="number" class="form-control" id="number_of_people" name="number_of_people">
            </div>

            <div id="venue_field" class="mb-3 hidden">
                <label for="venue_name" class="form-label fw-bold">Venue:</label>
            ...
            <div id="pickup_dropoff_field" class="mb-3 hidden">
                ...
                <label for="dropoff_location" class="form-label fw-bold mt-2">Dropoff Location:</label>
            ...
            <div id="flight_details_field" class="mb-3 hidden">
                ...
                <label for="return_date" class="form-label fw-bold mt-2">Return Date:</label>
