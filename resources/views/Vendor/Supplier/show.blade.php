            ...
            <div class="card" style="font-size: 0.9rem; font-family: sans-serif;">
                <div class="card-header">
                    <h4>Supplier Request Details
                        <a href="{{ route('supplier.index') }}" class="btn-sm btn btn-danger float-end" style="font-size: 0.9rem; font-family: sans-serif;">Back</a>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <a href="{{ route('supplier.edit', $supplier->id) }}" class="btn btn-warning" style="font-size: 0.9rem; font-family: sans-serif;">Edit</a>
                </div>
            </div>
        </div>
    </div>
